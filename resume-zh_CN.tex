...
\begin{document}
    ...
    \begin{onehalfspacing}
        \begin{itemize}
            \item 5年Java项目开发经验：美团点评3年，创业公司1年，并在搜狐、58同城有过两段实习经历
            \item 拥有扎实Java基础和计算机基础知识（数据结构、算法、操作系统、网络及数据库）
            \item 掌握Jvm原理和机制，具备Jvm性能调优能力
            \item 熟悉常用技术框架和中间件（Spring/SpringBoot/MyBatis/Kafka/Redis等）
            \item 熟悉分布式系统相关技术（分布式缓存、分布式事务、消息队列、限流熔断、容灾降级等）
            \item 掌握高并发、高可用系统设计方案，并参与过公司基础服务的搭建和维护
            \item 能独立承担大型软件项目系统分析和架构设计，有相关系统软件架构设计经验
            \item 有技术热情，有良好的计划、沟通、组织协调能力，较强的项目管理能力和应变能力
            \item 有带人经验，帮助新人快速熟悉业务、制定培养计划，工作任务拆分、设计指导和进度把控
        \end{itemize}
    \end{onehalfspacing}
    \blankline{ }
    ...
    \begin{onehalfspacing}
        \datedline{\textbf{页面异常监控系统}}{2019.05 - 2019.11}
    ...
    \datedsubsection{\textbf{Magento2中文化} \hfill \textit{\href{https://github.com/benheart/magento2\_zh\_hans\_cn}{https://github.com/benheart/magento2\_zh\_hans\_cn}}}{2017.06}
    \begin{onehalfspacing}
        \begin{itemize}
    ...
    \datedline{\textit{美团点评“专利创客”荣誉称号}}{2020.03}
