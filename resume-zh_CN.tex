...
\begin{document}
    ...
    \datedsubsection{\textbf{美团点评(上海)} \hfill \textit{Java 后台开发}}{2017.07 - 至今}
    \begin{onehalfspacing}
        ...
        \begin{itemize}
            \item 无任何代码侵入，接入成本极低
            \item 支持 Jsoup、HtmlUnit、Selenium 三种爬取方式
    ...
    \datedsubsection{\textbf{上海叶道科技有限公司} \hfill \textit{Java 开发工程师}}{2016.07 - 2017.07}
    \begin{onehalfspacing}
        \datedline{\textbf{WhatsMODE 网站全栈开发}}{2016.12 - 2017.07}
        \begin{itemize}
    ...
    \begin{onehalfspacing}
        \datedline{\textbf{MODE APP 后台开发}}{2016.07 - 2016.11}
        \begin{itemize}
